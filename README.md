...
[![Installs](https://img.shields.io/visual-studio-marketplace/i/Codag.codag)](https://marketplace.visualstudio.com/items?itemName=Codag.codag)
...
2. Run **"Codag: Open"** to analyze your workspace
3. Click nodes to see source locations, descriptions, and navigate to code
...
| Blue button | Reset layout |
| Red button | Reanalyze |
...
**Backend won't start:** `lsof -i :8000` to check for port conflicts, `make stop` to kill it.
